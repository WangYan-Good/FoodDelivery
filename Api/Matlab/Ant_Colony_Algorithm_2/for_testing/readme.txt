Ant_Colony_Algorithm_2 MATLAB Java Package
...
- Ant_Colony_Algorithm_2.jar must be included in your CLASSPATH.
...
-MCRInstaller.exe 
    ...
    Deployment Tool.
-Javadoc   
   - javadoc for Ant_Colony_Algorithm_2 is in the doc directory. When  
