Ant_Colony_Algorithm MATLAB Python Package
...
2. Installing the Ant_Colony_Algorithm Package

A. Change to the directory that contains the file setup.py and the subdirectory 
Ant_Colony_Algorithm. If you do not have write permissions, copy all its contents to a 
...
3. Using the Ant_Colony_Algorithm Package

The Ant_Colony_Algorithm package is on your Python path. To import it into a Python 
script or session, execute:

    import Ant_Colony_Algorithm
